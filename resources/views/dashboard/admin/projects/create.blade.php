...
<div class="pt-3 pb-2 mb-3">
  <h1 class="h2 text-dark">Insert Project</h1>

  <div class="border-top my-3"></div>

  <form action="/dashboard/admin/projects" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <button type="submit" class="btn btn-primary w-100">Insert Project</button>
